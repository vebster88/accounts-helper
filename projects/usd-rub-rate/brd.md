...
**Критерии приёмки:**
- Поддерживается основной источник: официальный API ЦБ РФ (`https://www.cbr-xml-daily.ru/daily_json.js`).
...
**Описание:** ЦБ РФ или fallback-источник могут изменить URL или формат ответа.  
**Вероятность:** Средняя.  
**Влияние:** Среднее.  
**Митигация:** Версионировать скрипт, поддерживать fallback, добавить тест на парсинг ответа.
